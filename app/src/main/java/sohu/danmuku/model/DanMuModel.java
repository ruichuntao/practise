...
public class DanMuModel implements OnDanMuViewTouchListener, Comparable {
    ...
    public int compareTo(Object o) {
        if (o instanceof DanMuModel) {
            return this.order - ((DanMuModel) o).order;
        }
        return 0;
    }
}
